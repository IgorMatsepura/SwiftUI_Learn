...
//  learnSwiftUI
//
//  Created by Igor Matsepura on 31.01.2022.
//
...
struct RestaurantPhotosView: View {
    ...
    let photosUrl = [      "https://letsbuildthatapp-videos.s3.us-west-2.amazonaws.com/e2f3f5d4-5993-4536-9d8d-b505d7986a5c",
    ...
    init() {
        ...
        UISegmentedControl.appearance().setTitleTextAttributes(titleText, for: .normal)
