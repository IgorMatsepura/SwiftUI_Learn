...
//                Image(user.nameImages)
                ...
                ForEach(vm.userDetails?.posts ?? [], id: \.self) { num in
                    ...
                    VStack(alignment: .leading, spacing: 12) {
                        ...
                        HStack {
                            ForEach(num.hashtags, id: \.self) { hashtag in
...
struct UserDetailsView_Previews: PreviewProvider {
    static var previews: some View {
        UserDetailsView(user:.init(id: 0, name: "Amy Adam", nameImages: "cam"))
    }
}
